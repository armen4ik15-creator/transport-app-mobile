...
export function RegistryPreviewTable({ rows, maxRows = 8 }: RegistryPreviewTableProps) {
  ...
  return (
    <View style={{ marginTop: 16 }}>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator>
        <View>
          ...
          {visible.map((row) => (
            <View
              key={row.id}
              style={{ flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: '#f3f4f6' }}
            >
              <Text style={{ width: 100, padding: 8, fontSize: 11, color: '#111827' }}>
              ...
              <Text style={{ width: 100, padding: 8, fontSize: 11, color: '#16a34a' }}>
      ...
      <Text style={{ fontSize: 14, fontWeight: '700', color: '#16a34a', marginTop: 10 }}>
